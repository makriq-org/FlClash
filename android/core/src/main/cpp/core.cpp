...
Java_com_makriq_flclash_core_Core_startTun(JNIEnv *env, jobject thiz, jint fd, jobject cb,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_makriq_flclash_core_Core_stopTun(JNIEnv *env, jobject thiz) {
    stopTun();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_makriq_flclash_core_Core_forceGC(JNIEnv *env, jobject thiz) {
    forceGC();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_makriq_flclash_core_Core_updateDNS(JNIEnv *env, jobject thiz, jstring dns) {
    updateDns(get_string(dns));
}

extern "C"
JNIEXPORT void JNICALL
Java_com_makriq_flclash_core_Core_invokeAction(JNIEnv *env, jobject thiz, jstring data, jobject cb) {
    const auto interface = new_global(cb);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_makriq_flclash_core_Core_setEventListener(JNIEnv *env, jobject thiz, jobject cb) {
    if (cb != nullptr) {
        const auto interface = new_global(cb);
...
Java_com_makriq_flclash_core_Core_getTraffic(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_makriq_flclash_core_Core_getTotalTraffic(JNIEnv *env, jobject thiz,
                                                const jboolean only_statistics_proxy) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_makriq_flclash_core_Core_suspended(JNIEnv *env, jobject thiz, jboolean suspended) {
    suspend(suspended);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_makriq_flclash_core_Core_quickSetup(JNIEnv *env, jobject thiz, jstring init_params_string,
...
JNI_OnLoad(JavaVM *vm, void *) {
    ...
    const auto c_tun_interface = find_class("com/makriq/flclash/core/TunInterface");

    const auto c_invoke_interface = find_class("com/makriq/flclash/core/InvokeInterface");
