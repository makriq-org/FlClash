...
- Добавлена автоматическая Android-диагностика после запуска или применения профиля.
- Диагностика не включает секреты, ссылку профиля, журналы соединений и полный список приложений.
- Если первая отправка не дошла из-за сети, приложение повторяет её без суточной задержки.

## v0.9.21-pre2

- Диагностика повторяет отправку после неудачной попытки и не ждёт сутки, если сеть ещё не была готова.

## v0.9.21-pre1

- Добавлена автоматическая отправка короткой Android-диагностики после применения профиля.
- Диагностика не включает секреты, ссылку профиля, журналы соединений и полный список приложений.
- Отправка ограничена по частоте и не мешает работе приложения без сети.
