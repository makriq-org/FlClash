...
- Обновлено сетевое ядро mihomo до более свежей линии с исправлениями устойчивости и безопасности.
- Расширена совместимость прокси и транспортов для новых конфигураций и провайдеров.
- Синхронизирована обвязка клиента для корректной работы списков прокси и обновления геобаз после подъёма ядра.
