...
FlClash — Clash-совместимый клиент, у которого этот форк развивает именно Android-продукт. Репозиторий остаётся технически кроссплатформенным, но все продуктовые приоритеты, документация и релизная логика здесь подчинены Android-направлению.

## Зачем нужен этот форк

Форк решает две практические задачи:

- развивать исключительно Android-направление и делать его лучше, чем это возможно в апстриме;
...
- Android — основной и единственный продуктовый фокус этого форка
